...
6. sub-project 6: COAD = colon adenocarcinoma;
7. sub-prohect 7: LIHC = liver hepatocarcinoma; 
8. sub-project 8: LUSC = lung small cell carcinoma
...
3. a R object containing, for 8 tumor types, the expression data of matched tumor and normal tissue; you can download this object `GKBioinfo_tumor_normal.rds` using this link [https://figshare.com/s/5bd4cf0fc7a0af36b767](https://figshare.com/s/5bd4cf0fc7a0af36b767)
